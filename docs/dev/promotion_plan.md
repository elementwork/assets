...
| **Family** | $39 one-time (or $5/mo) | Everything free + file lock + audit + print binder + future Ontario intelligence (EAT, readiness score) + email support |
...
- Monetize the *dashboard intelligence* (file lock, audit, Ontario calculators), not the file format.
